...
.captcha-box {
    width: 140px; height: 37.5px; position: relative;
    img {
        width: 140px; height: 37.5px;
    }
    .captcha-placeholder {
        position: absolute; height: 37.5px; width: 122px; top: 0; left: 9px;
        span {
            width: 20px; text-align: center; height: 18px; overflow: hidden; color: red; line-height: 18px; padding: 10px 0; cursor: pointer; display: inline-block; box-sizing: content-box;
            i {
                display: none;
            }
        }
