...
var DB = function( config ) {
    ...
    this.config.expire || ( this.config.expire = 7000 );
...
DB.prototype.connect = function() {
    ...
    this.client.on('ready', function() {
        console.log('wx-sharing redis ready');
    });
    this.client.on('connect', function() {
        console.log('wx-sharing redis connect');
    });
    this.client.on('reconnecting', function() {
        console.log('wx-sharing redis reconnecting');
    });
    this.client.on('error', function(err) {
        console.log('wx-sharing redis error', err);
    });
};
