...
export default (Vue, Options = {}) => {
    ...
    const onListen = (el, start) => {
        if (start) {
            ...
            _.on(el, 'touchmove', lazyLoadHandler); //for mobile scorll
            ...
            _.off(el, 'touchmove', lazyLoadHandler); // for mobile scroll
